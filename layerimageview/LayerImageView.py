# -*- coding: utf-8 -*-
"""
LayerImageView.py -  Widget for basic image dispay and analysis
...
if USE_PYSIDE:
    from .LayerImageViewTemplate_pyside import *
else:
    from .LayerImageViewTemplate_pyqt import *
...
class LayerImageView(QtGui.QWidget):
    """
    ...
    * Basic analysis features including:
    ...
    def __init__(self, parent=None, name="LayerImageView", view=None, imageItem=None, *args):
        """
    ...
    def addLayer(self,layerName,layerType='data'):
        self.layers[layerName] = Layer(layerName=layerName,layerType=layerType,layerData=None)
    ...
    def setImage(self, img, autoRange=True, autoLevels=True, levels=None, axes=None, xvals=None, pos=None, scale=None, transform=None):
        ...
        *transform*    Set the transform of the dispalyed image. This option overrides *pos*
        ...
        ============== =======================================================================
        """
        prof = debug.Profiler('LayerImageView.setImage', disabled=True)
    ...
    def getProcessedImage(self):
        ...
        if self.imageDisp is None:
            ...
            self.levelMin, self.levelMax = list(map(float, LayerImageView.quickMinMax(self.imageDisp)))
    ...
    def getImageItem(self):
        """Return the ImageItem for this LayerImageView."""
        return self.imageItem
        
    def getRoiPlot(self):
        """Return the ROI PlotWidget for this LayerImageView"""
        return self.ui.roiPlot
       
    def getHistogramWidget(self):
        """Return the HistogramLUTWidget for this LayerImageView"""
        return None
